...
import com.iihtibm.sba.service.TrainingService;
...
import com.iihtibm.sba.model.Constants.TrainingStatus;
...
public class TrainingsController {
	...
	// send Proposal
	@ApiOperation(value = "Add training details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
	...
	public com.iihtibm.sba.model.ApiResponse<?> proposeTraining(
			@ApiParam(value = "Training details which needs to add", required = true) @Valid @RequestBody Training training) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.training.proposal"),
				trainingService.proposeTraining(training));

	}

	@ApiOperation(value = "Approve/Reject training details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
	...
	public com.iihtibm.sba.model.ApiResponse<?> approveTraining(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.training.approve", status),
				trainingService.updateTraining(training, authToken));

	}

	@ApiOperation(value = "Update training details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 302, message = "Resource Exist"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
	...
	public com.iihtibm.sba.model.ApiResponse<?> updateTraining(
			@ApiParam(value = "Training details which needs to update", required = true) @Valid @RequestBody Training training, 
			@ApiParam(value = "GWT authentication token", required = true) @RequestHeader("Authorization") String authToken) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.training.update"),
				trainingService.updateTraining(training, authToken));

	}

	@ApiOperation(value = "Delete training details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> deleteTraining(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.training.delete"));
	}
